...
public func -= <T:VectorOperatable, U:VectorOperatable>(lhs: inout T, rhs:U)  {
    lhs = lhs - rhs
}
...
public func /= <T:VectorOperatable, U:VectorOperatable>(lhs:inout T, rhs:U) -> T  {
    lhs = lhs / rhs
    return lhs
}
...
public func /= <T:VectorOperatable>(lhs:inout T, scalar:Double) -> T  {
    lhs = lhs / scalar
    return lhs
}
...
func *= <T:VectorOperatable>( lhs: inout T, value:Double)   {
    lhs = lhs * value
}
